        ...
        <div className="order-2 lg:order-1 flex flex-col items-center lg:items-start text-center lg:text-left max-w-xl">
          ...
          >
            ...
            <button
              ...
              className="group inline-flex items-center gap-3 px-6 py-3.5 rounded-2xl bg-white/[0.03] hover:bg-white/[0.08] text-neutral-200 hover:text-white font-medium text-sm border border-white/[0.08] hover:border-white/[0.16] backdrop-blur-md transition-all duration-300 shadow-sm cursor-pointer disabled:opacity-50"
            >
              {isGoogleLoading ? (
                <svg
