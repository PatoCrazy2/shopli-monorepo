...
export function PrintLabelsModal({ isOpen, onClose, products }: PrintLabelsModalProps) {
  ...
  const handlePrint = async () => {
    ...
    if (printMode === "all") {
      if (globalQty <= 0) {
        alert("Por favor, ingresa una cantidad de copias mayor a 0.");
        return;
      }
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-2xl w-full max-w-xl shadow-xl flex flex-col overflow-hidden max-h-[90vh] animate-in zoom-in-95 duration-200">
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-xs text-zinc-500 mt-1">
                Genera planillas PDF con códigos QR listos para imprimir en tu formato preferido.
              </p>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="p-6 overflow-y-auto space-y-6 flex-1">
          ...
          <div className="space-y-3">
            <h4 className="text-xs font-black uppercase tracking-wider text-zinc-400">¿Qué deseas imprimir?</h4>
            <div className="flex rounded-lg bg-zinc-100 dark:bg-zinc-900 p-1">
              <button
                type="button"
          ...
          {printMode === "all" ? (
            ...
            <div className="p-5 rounded-xl border border-zinc-100 dark:border-zinc-900 bg-zinc-50/20 space-y-4 flex flex-col items-center justify-center text-center">
              ...
              <div>
                <h5 className="text-sm font-bold text-zinc-800 dark:text-zinc-200">Impresión Masiva de Catálogo</h5>
                <p className="text-xs text-zinc-400 mt-1 max-w-sm leading-relaxed">
                  Se generarán códigos QR para todos los productos y variantes del catálogo activo en un único PDF ordenado.
                </p>
              </div>
              <div className="flex items-center gap-3 mt-4 border-t border-zinc-100 dark:border-zinc-900 pt-4 w-full justify-center">
                ...
                <input
                  ...
                  className="w-20 h-10 text-center rounded-xl border border-zinc-300 dark:border-zinc-700 bg-transparent text-sm focus:outline-none focus:ring-1 focus:ring-black dark:focus:ring-white font-mono font-bold"
                />
              </div>
            </div>
          ) : (
            /* Modo Seleccionar: Buscador y Lista de checkboxes */
            <div className="space-y-3">
              ...
              {/* Lista Scrollable */}
              <div className="rounded-xl border border-zinc-200 dark:border-zinc-800 max-h-[260px] overflow-y-auto bg-zinc-50/10 divide-y divide-zinc-200 dark:divide-zinc-800">
